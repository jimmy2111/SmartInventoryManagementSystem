...
a {
  ...
  .my-button {
      ...
      text-align: center;
      text-decoration: none;
      background-image: linear-gradient(to right, #007bff, #00d3c5);
      color: #fff;
      border-radius: 4px;
	...
	<div id="carouselExampleAutoplaying" class="carousel slide  carousel-fade"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img
					src="https://st2.depositphotos.com/9999814/50628/i/1600/depositphotos_506286024-stock-photo-smart-warehouse-management-system-with.jpg"
					height="350" class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
				<img
					src="https://www.shutterstock.com/image-photo/smart-warehouse-management-system-innovative-260nw-2046011612.jpg"
					height="350" class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
				<img
					src="https://uploads-ssl.webflow.com/622faf89982b1a82750a4f2b/62fdfeea7607c844c31540a3_Omnichannel%20Inventory%20Management%20System%20-%20Header%20(1).jpg"
					height="350" class="d-block w-100" alt="...">
			</div>
		</div>
	  ...
	  <a href="AddProductPage" class="my-button">Add Product</a>
	  <a href="ViewProductData" class="my-button">View Product</a>
	  <a href="ViewSellerDetail" class="my-button">View Seller</a>
	  <a href="AddSenderDetail" class="my-button1">Add Seller Detail</a>
	  <a href="OrderHere" class="my-button2">Bill</a>
